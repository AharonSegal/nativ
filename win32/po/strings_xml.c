...
_("Thank you for installing Navit!\n\nTo start, select \"Download maps\" from the menu to download a map. Note: The map filesize may be large (&gt50MB) - a wifi connection is recommended.\n\nMapdata: (c) OpenStreetMap contributors\n\nEnjoy Navit!")
...
_("Sorry, we currently do not support maps above 3.8G on Android, please select a smaller one.")
...
_("Media selected for map storage is not available")
// Android resource: @strings/map_download_error_writing_map
_("Error writing map!")
// Android resource: @strings/map_location_changed
_("New location set to %s Restart Navit to apply the changes.")
// Android resource: @strings/map_location_unavailable
_("Current map location %s is not available Please restart Navit after you attach an SD card or select a different map location.")
...
_("Search")
// Android resource: @strings/    <string name="address_search_searching">Searching
_("    <string name="address_search_searching">Searching")
...
// Android resource: @strings/    <string name="backing_up">Backing up
_("    <string name="backing_up">Backing up")
// Android resource: @strings/    <string name="restoring">Restoring
_("    <string name="restoring">Restoring")
...
_("System text to speech engine data is missing")
// Android resource: @strings/TTS_qery_install_data
_("Navit can use any text to speech engine installed on your device. The currently selected engine reports it is unable to speak in your language. Should we ask the system to show voice download dialog?")
// Android resource: @strings/permissions_not_granted
_("Navit needs permission to access GPS and read the map.\nIf you change your mind please restart Navit and grant the permissions")
// Android resource: @strings/permissions_info_box_title
_("One or more ungranted permissions")
