...
void	module_binding_win32_init(void);
...
void	module_traffic_dummy_init(void);
void	module_traffic_null_init(void);
void	module_graphics_win32_init(void);
extern void builtin_init(void);
void builtin_init(void) {
    
module_binding_win32_init();
...
module_map_csv_init();
module_traffic_dummy_init();
module_traffic_null_init();
module_graphics_win32_init();
}
